    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-center col-span-3 space-y-4">
            <div class="main-center mx-auto grid grid-cols-2 gap-4">
                <a class="inline-block py-4 px-6 text-right text-black underline underline-offset-2">Following</a>
                <RouterLink to="feed" class="inline-block py-4 px-6 text-left text-black underline-offset-2">Recomendation</RouterLink>
            </div>
